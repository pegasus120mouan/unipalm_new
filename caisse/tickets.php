        ...
        <div class="modal-content">
         ...
         <div class="modal" id="valider_ticket<?= $ticket['id_ticket'] ?>">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-body">
                <form action="traitement_paye.php" method="post">
                  <input type="hidden" name="id_ticket" value="<?= $ticket['id_ticket'] ?>">
                  <div class="form-group">
                    <label>Effectuer un paiement</label>
                  <div class="form-group">
                  <label>Montant à payer</label>
                      <input 
                      type="text" 
                      class="form-control text-bold-red" 
                      id="exampleInputEmail1" 
                      placeholder="<?php echo $ticket['montant_paie'] ?>" 
                      disabled>
                   </div>
                  <div class="form-group">
                   <label>Montant payé</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Montant payé" name="montant_paye">
                   </div>
                  <button type="submit" class="btn btn-primary mr-2" name="saveCommande">Payé</button>
                </form>
              </div>
            </div>
          </div>
